    ...
    def parse_line(self, line: str) -> Dict[str, Any]:
        ...
        for key, pattern in self.patterns.items():
            ...
            if match:
                ...
                elif key in ['total_execs', 'paths_found', 'crashes', 'hangs', 'cycles_done']:
...
class AFLProcessManager:
    ...
    def __init__(self, 
        ...
        # 回调函数
        self.on_state_change: Optional[Callable[[AFLFuzzingState, AFLStats], None]] = None
    ...
    def get_progress_message(self) -> str:
        ...
        if self.state == AFLFuzzingState.STARTING:
            ...
            # 使用监控器的崩溃计数（更准确）
            crash_count = self._crash_monitor.get_crash_count() if self._crash_monitor else self.stats.crashes_found
            if crash_count > 0:
